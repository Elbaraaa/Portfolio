...
export function AchievementsSection({ C }) {
  ...
  return (
    <section id="achievements" ref={ref} className="section-pad" style={{padding:"80px 60px",background:"transparent",minHeight:"100vh",display:"flex",alignItems:"center"}}>
      <div style={{maxWidth:1080,margin:"0 auto",width:"100%"}}>
        ...
        <div className="achieve-grid" style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:14}}>
          {achievements.map((a,i)=>(
            <div key={a.title} style={mkPanel(C,{
              padding:22,
              ...
              onMouseEnter={e=>{e.currentTarget.style.borderColor=`${C.accent}40`;e.currentTarget.style.boxShadow=`0 0 24px ${C.accent}25, 0 4px 20px rgba(0,0,0,0.4)`;e.currentTarget.style.transform="translateY(-3px)";}}
              onMouseLeave={e=>{e.currentTarget.style.borderColor=C.border;e.currentTarget.style.boxShadow=`0 2px 16px rgba(0,0,0,0.35), inset 0 1px 0 rgba(255,255,255,0.04)`;e.currentTarget.style.transform="none";}}>
